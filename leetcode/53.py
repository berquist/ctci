class Solution:
    ...
    def maxSubArray_naive(self, nums):
        ...
        :rtype: int
        """
        # first the naive solution: find the sum of all contiguous
        # permutations lower than and up to the current index
        largest_sum = nums[0]
        if len(nums) == 1:
            return largest_sum
